  ...
  <header class="navbar bg-background-primary pl-16 pr-6 py-3 sm:pl-6">
    ...
    >
      ...
      <NavLinks class="hidden sm:block"/>
        ...
        <button role="button" aria-label="Toggle dark/light" @click.prevent="toggleTheme" class="hidden sm:block ml-4 text-primary bg-transparent border-0 focus:outline-none hover:text-link">
